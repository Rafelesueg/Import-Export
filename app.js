...
let products = [
    ...
    { id: 61, name: 'Pack 10 ammo-9 ($5-$7)', price: 0.5, group: 'armi' },
    { id: 62, name: 'Pack 10 ammo-44 ($5-$7)', price: 0.5, group: 'armi' },
    { id: 63, name: 'Pack 10 ammo-shotgun ($7-$8)', price: 0.7, group: 'armi' },
    ...
    { id: 82, name: 'Cavo da traino', price: 10, group: 'auto' },
    { id: 83, name: 'Motore 4 cilindri', price: 100, group: 'auto' },
    { id: 84, name: 'Motore 6 cilindri', price: 250, group: 'auto' },
    { id: 85, name: 'Motore v6', price: 300, group: 'auto' },
    { id: 86, name: 'Motore v8', price: 500, group: 'auto' },
    { id: 87, name: 'Motore v12', price: 600, group: 'auto' },
    { id: 88, name: 'Freni a tamburo', price: 8, group: 'auto' },
    { id: 89, name: 'Freni a disco', price: 10, group: 'auto' },
    { id: 90, name: 'Frani a disco in ceramica', price: 15, group: 'auto' },
    { id: 91, name: 'Freni a disco in carbonio-ceramica', price: 25, group: 'auto' },
    { id: 92, name: 'Trasmissione variaz continua', price: 65, group: 'auto' },
    { id: 93, name: 'Trasmissione doppia frizione', price: 70, group: 'auto' },
    { id: 94, name: 'Trasmissione variaz continua elettronica', price: 90, group: 'auto' },
    { id: 95, name: 'Trasmissione doppia frizione elettronica', price: 100, group: 'auto' },
    { id: 96, name: 'Batteria al piombo', price: 30, group: 'auto' },
    { id: 97, name: 'Batteria al litio', price: 50, group: 'auto' },
    { id: 98, name: 'Olio minerale', price: 40, group: 'auto' },
    { id: 99, name: 'Olio sintetico', price: 55, group: 'auto' },
    { id: 100, name: 'Olio a bassa viscosità', price: 70, group: 'auto' },
    { id: 101, name: 'Sospensione a balestra', price: 35, group: 'auto' },
    { id: 102, name: 'Sospensione indipendente', price: 40, group: 'auto' },
    { id: 103, name: 'Sospensioni ad aria', price: 60, group: 'auto' },
    { id: 104, name: 'Candele rame', price: 10, group: 'auto' },
    { id: 105, name: 'Candele platino', price: 30, group: 'auto' },
    { id: 106, name: 'Candele iridio', price: 25, group: 'auto' },
    { id: 107, name: 'Copertone di fabbrica', price: 20, group: 'auto' },
